...
- `readme-sync.md` - README-CN.md 和 README.md 的同步要求。
- `release-packaging.md` - 测试、打包和正式发布的触发规则。
- `rules-governance.md` - 什么时候新增或修改规则。

Rules 是策略约束，不是用户教程。教程和产品解释应放在 `docs/`。
